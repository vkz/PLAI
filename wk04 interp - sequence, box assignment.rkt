...
;; boxes
(test (get-value (interpret (desugar (boxS (plusS (numS 1) (numS 0))))))
      1)
(test (get-value (interpret (desugar (unboxS (boxS (plusS (numS 1) (numS 0)))))))
      1)
(test (get-value (interpret (desugar (letS 'b 
                       (boxS (numS 0)) 
                       (seqS (list (seqS (list (setboxS (idS 'b) (plusS (numS 1) (unboxS (idS 'b))))
